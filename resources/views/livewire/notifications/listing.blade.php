<div class="sm:relative -m-2" x-data="{ open: false }" @click.away="open = false" wire:poll.visible="fetchNotifications">
    <button
        ...
        :class="{ 'bg-white/75 dark:bg-transparent': open }"
    ...
    <div
        class="absolute top-full left-4 sm:left-auto right-4 sm:right-0 backdrop-blur-md bg-white/75 dark:bg-black/50
    ...
    >
        ...
        @empty
            <div class="border-t border-indigo-50 dark:border-gray-800 px-4 pb-6 pt-7 text-center text-black/30 dark:text-gray-400 text-sm">
