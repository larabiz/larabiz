<x-app title="À propos">
    <x-section>
        ...
        <p class="mt-4">À travers {{ config('app.name') }}, j'ai envie d'aider les développeurs à accumuler autant d'expérience, tout en leur évitant de refaire les mêmes erreurs.<br />
        Étant autodidacte depuis mon adolescence, il est bien normal que je contribue à la communauté.</p>
    </x-section>
</x-app>
